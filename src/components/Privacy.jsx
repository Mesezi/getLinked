...
const Privacy = () => {
  return (
   <section className="container p-10 gap-28 lg:gap-10 grid grid-cols-1 min-h-screen lg:grid-cols-2 py-20 md:px-0 mx-auto">
...
<h3 className='text-lightPurple font-bold'>Licensing Policy</h3>
...
<button className='w-44 py-3 gradient self-center mt-3'>Read More</button>
</article>
...
<div className='h-[44rem] relative w-full'> 
<svg className='absolute w-[80%] test h-full' viewBox="0 0 530 648" fill="none" xmlns="http://www.w3.org/2000/svg">
