      ...
      <div className='container mx-auto p-10 lg:py-16 md:px-0 grid grid-cols-1 text-center lg:text-start gap-16 lg:grid-cols-2'>
        ...
        data-aos-offset="400"
         className='flex justify-center relative'>
            <img
             src="/assets/idea.png" className='object-contain' alt="idea image" />
            <img src="/assets/gradient star.png" className='h-6 twinkle-animation absolute top-[30%] left-0' alt="star" />
            <img src="/assets/spiral arrow.png" className='absolute h-6 sm:h-auto 
            lg:bottom-[-5%] lg:left-[85%] bottom-[-6%] left-1/2 transform -translate-x-1/2 lg:translate-x-0' alt="star" />
        </div>
        ...
        <div className='flex flex-col justify-center gap-3 '>
            ...
            <img src="/assets/purple star.png" className='absolute twinkle-animation h-4 sm:h-auto top-[40%] lg:top-[23%] right-0' alt="star" />
            </h2>
            <p
            data-aos="fade-left"
            data-aos-duration="1000"
