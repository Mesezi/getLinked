      ...
      <div className='container mx-auto p-10 lg:py-16 md:px-0 grid grid-cols-1 text-center lg:text-start gap-16 lg:grid-cols-2'>
        ...
        data-aos-offset="400"
         className='flex justify-center relative'>
            <img
             src="/assets/idea.png" className='object-contain' alt="" />
            <img src="/assets/gradient star.png" className='h-6 twinkle-animation absolute top-[30%] left-0' alt="" />
        ...
        <div className='flex flex-col justify-center gap-3 '>
            ...
            <img src="/assets/purple star.png" className='absolute twinkle-animation h-4 sm:h-auto top-[40%] lg:top-[23%] right-0' alt="" />
            </h2>
            <p
            data-aos="fade-left"
            data-aos-duration="1500"
