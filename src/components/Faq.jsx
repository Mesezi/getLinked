...
const Faq = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center gap-3 lg:w-[440px] pt-10'>
          ...
          <img src="/assets/purple star.png" className="absolute twinkle-animation h-6 lg:h-auto
           top-[-40%] left-[-40%] lg:top-[-70%] lg:left-[-10%]" alt="star" />
          </h2>
          <p 
           data-aos="fade-right"
           data-aos-duration="1000"
          className='lg:text-[14px] font-[200] leading-[2rem] mx-auto lg:mx-0 lg:max-w-xs'>
      ...
      className='grow flex justify-center relative z-10'>
          <img src="/assets/man on cloud.png" className='object-contain pt-7' alt="Man on cloud image" />
...
<img src="/assets/gradient star.png" className='absolute twinkle-animation h-4 md:h-auto top-[-3%] right-[48%] lg:top-[2%] lg:right-[52%]' alt="star"/>
<img src="/assets/gradient star.png" className='absolute twinkle-animation h-2 md:h-auto top-[36%] lg:top-[22%] right-[75%]' alt="star" />
<img src="/assets/gray star.png" className='absolute twinkle-animation h-4 md:h-auto top-[52%] right-[88%]' alt="star" />
<img src="/assets/white star.png" className='absolute twinkle-animation h-4 md:h-auto top-[97%] right-[20%]' alt="star" />
      </div>
