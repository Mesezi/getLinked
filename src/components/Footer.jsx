...
const Footer = () => {
  return (
    <footer className="bg-[#100B20] p-10 md:px-0 py-20">
      <div className="container mx-auto flex flex-col lg:flex-row gap-10 justify-between">
        <article className="lg:w-[45%] flex flex-col gap-5 text-sm">
          <img
            ...
            alt="getlinked logo"
          />
          <p className="lg:max-w-md leading-[20px] relative">
            Getlinked Tech Hackathon is a technology innovation program
            established by a group of organizations with the aim of showcasing
            young and talented individuals in the field of technology
            <img
              src="/assets/white star.png"
              className="absolute object-contain h-3 md:h-5 twinkle-animation top-1/2 lg:top-0 left-[-8%]"
              alt="star"
            />
          </p>
          <p className="flex gap-3 mt-auto">
        ...
        <article className="space-y-4 relative">
          <img
            ...
            className="absolute object-contain h-4 md:h-5 twinkle-animation right-[51%] top-[55%]
     lg:right-[-23%] lg:top-[15%]"
            alt="star"
          />
          ...
          <div className="flex gap-4 items-center">
            <h4 className="font-semibold text-lightPurple">Follow us</h4>
        ...
        <article className="space-y-4 relative">
          <img
            src="/assets/white star.png"
            className="absolute object-contain h-3 md:h-5 twinkle-animation right-[20%] bottom-20 lg:right-[-5%] lg:bottom-0"
            alt="star"
          />
      ...
      <p className="text-center text-sm mt-16 relative">
        All rights reserved. © getlinked Ltd.
        <img
          src="/assets/gradient star.png"
          className="absolute object-contain h-3 md:h-5 twinkle-animation right-1/2 top-[-170%]"
          alt="star"
        />
      </p>
    </footer>
