    ...
    <section className="flex flex-col gap-5 lg:h-[calc(100vh-90px)] border-white/10 border-b-[1px]">
      <div className="pt-4 font-bold italic container mx-auto">
        <div className="flex justify-center lg:justify-end items-center relative">
          <span
            ref={el}
            className="text-xl text-center lg:text-right lg:text-3xl font-bold lg:h-12"
          />
     ...
     lg:pl-[calc((100%-1024px)/2)] xl:pl-[calc((100%-1280px)/2)] hero-container relative"
      >
        <img
          src="/assets/flare.png"
          className="absolute blend-mode max-h-[49rem] w-full object-contain top-[-5rem] left-[-3rem] 
      lg:top-[-23rem] lg:left-[-16rem]"
          alt="flare image"
        />
        ...
        <article className="h-full box1 relative flex flex-col gap-7 px-10 sm:px-0">
          <div className="hidden lg:block w-full h-[30vh] z-10 relative">
            <img
              ...
              alt="Desktop view title"
            />
            <img
              src="/assets/white star.png"
              className="twinkle-animation absolute h-8 object-contain top-[-10%] left-[9%]"
              alt=""
            />

            <img
              src="/assets/gray star.png"
              className="absolute twinkle-animation h-4 lg:h-8 object-contain top-0 right-0"
              alt=""
            />
          </div>
          ...
          <div className="lg:hidden mt-6 lg:mt-0 max-h-56 self-center relative">
            ...
            <img
              src="/assets/white star.png"
              className="twinkle-animation absolute h-4 object-contain top-[-13%] left-[24%]"
              alt=""
            />
            <img
              src="/assets/gray star.png"
              className="absolute twinkle-animation h-4 object-contain top-[-13%] right-0"
              alt=""
            />
          </div>
          ...
          <p
            ...
            className="max-w-md mx-auto lg:mx-0 text-center lg:text-start"
          >
          ...
          <Link
            ...
            data-aos-duration="1000"
            to="/register"
            className="gradient self-center text-center lg:self-start w-40 py-3 relative"
          >
            Register
            <img
              src="/assets/gray star.png"
              className="absolute twinkle-animation h-4 lg:h-8 object-contain top-[40%] -right-[20%] lg:top-[150%] lg:-right-[240%]"
              alt=""
            />
          </Link>
          ...
          <div
            data-aos="fade-up"
            data-aos-duration="1000"
            className="text-[4rem] flex justify-center lg:justify-start gap-4 lg:mt-5 time"
          >
            <p className="time">
              {hours}
        ...
        <article className="relative box2">
          <div className="grow h-full relative">
            <img
              src="/assets/flare.png"
              className="absolute hidden lg:block w-full object-contain 
        top-[-64%] scale-[.4] left-[35%]"
              alt="flare image"
            />
            <img
              src="/assets/vr.png"
