...
companies as its partners and sponsors</p>
            ...
            <img src="/assets/partner.png" className='object-contain rounded-md border-[1px] border-lightPurple' alt="" />
            <img src="/assets/white star.png" className='h-3 twinkle-animation md:h-auto object-contain absolute top-[90%] left-[85%] lg:top-[80%] lg:left-[55%]' alt="" />
            <img src="/assets/purple star.png" className='h-3 twinkle-animation md:h-auto object-contain absolute top-0 left-10 lg:top-[-10%] lg:left-20 ' alt="" />
            <img src="/assets/gradient star.png" className='h-3 twinkle-animation md:h-auto object-contain absolute top-[37%] lg:top-[16%] left-[55%]' alt="" />
            </div>
